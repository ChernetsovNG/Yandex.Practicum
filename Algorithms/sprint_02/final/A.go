...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
Поскольку мы работаем с массивом элементов в памяти с доступом по индексу, и при операциях просто перемещаем
...
Для хранения элементов используются два указателя и массив постоянной длины n. Требуемый объём памяти составляет O(n).
*/
